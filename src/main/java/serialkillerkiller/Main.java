package serialkillerkiller;

import serialkillerkiller.bypass.*;
...
public class Main {
    ...
    private static void printUsage() {
        ...
        System.err.println("Usage: java -cp [path to ysoserial-...-all.jar] serialkillerkiller.Main [payload type] [bypass type] '[command to execute]'");
        ...
        //payloadClasses.sort(new GeneratePayload.ToStringComparator()); // alphabetize
